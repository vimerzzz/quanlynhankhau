...
public class ThuTienPanelController {
    ...
    private JTextArea diaChiJta;
    
    public ThuTienPanelController(HoKhauBean hoKhauBean, JTextField searchJtf, JPanel tableJpn) {
    ...
    public void setDataJtf(JTextField maHoKhauJtf, JTextField tenChuHoJtf, JTextField maKhuVucJtf, JTextArea diaChiJta) {
        this.diaChiJta = diaChiJta;
    ...
    public void setData() {
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                diaChiJta.setText(hoKhauBean.getHoKhauModel().getDiaChi());
